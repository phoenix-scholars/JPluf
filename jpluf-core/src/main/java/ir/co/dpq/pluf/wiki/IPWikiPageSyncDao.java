...
/**
 * دسترسی به صفحه‌های ویکی را به صورت همزمان فراهم می‌کند
 *
 * صفحه‌های ویکی به عنوان یک منبع راهنما برای کاربران ایجاد شده است.
 * 
 * این واسط ابزارهای مورد نیاز برای دسترسی به این صفحه‌ها را به صورت همزمان فراهم کرده است.
 *
 */
public interface IPWikiPageSyncDao {
